      ...
      <div className="flex flex-col gap-16">
        ...
        <section className="flex flex-col gap-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-slate-500 max-w-sm mx-auto">
              Practical guides on preparing, structuring, and submitting a Google Business Profile reinstatement appeal.
            </p>
          </div>
          ...
          <ul className="flex flex-col gap-4">
            {GUIDES.map((guide) => (
              <li key={guide.href}>
                <Link
                  href={guide.href}
                  className="group flex flex-col gap-2 rounded-xl border border-slate-200 bg-white p-5 shadow-sm transition-shadow hover:shadow-md hover:border-emerald-200"
                >
